...
function HomePage() {
    ...
    return (
        <div>
            <NavBar1 />
            <div className="container-fluid" style={{ backgroundImage: `url(${a})`, backgroundRepeat: "no-repeat", backgroundSize: "100% 100%" }}><br></br>
                ...
                <div className='container' style={{
                    ...
                    <div className="card bg-light text-dark" style={{ width: "320px", height: "450px", borderRadius: "3em" }}>
